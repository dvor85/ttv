...
if platform.system() == 'Linux':
    ...
    sys.path.insert(0, os.path.expanduser('~/eclipse/plugins/org.python.pydev.core_7.5.0.202001101138/pysrc'))
elif platform.system() == 'Windows':
    print("Append pydevd for Windows")
    sys.path.insert(0, 'd:\\python\\eclipse\\plugins\\org.python.pydev.core_7.5.0.202001101138\\pysrc')
