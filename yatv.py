...
class YATV():
    ...
    def update_yatv(self):
        ...
        Lcnl = (1867, 1861, 1856, 1853, 1852, 1845, 1844, 1843, 1842, 1841, 1838, 1834, 1828, 1827, 1821, 1820, 1817, 1816, 1815,
                1814, 1810, 1809, 1808, 1807, 1806, 161, 1804, 1803, 1802, 1799, 1798, 1794, 1793, 1790, 1785, 1784, 1783, 1782,
                1781, 1780, 1778, 1767, 1773, 1772, 1766, 1765, 1764, 1763, 1762, 1761, 1760, 1759, 1757, 1755, 1754, 1753, 690,
                1744, 1743, 1746, 1738, 1737, 1734, 1736, 1732, 1731, 1727, 1728, 1730, 1729, 1726, 1725, 1721, 1723, 1722, 1720,
                1716, 1714, 1702, 1719, 1713, 1703, 1698, 1700, 1699, 932, 1666, 363, 248, 180, 509, 730, 1396, 576, 141, 37, 6,
                783, 275, 618, 1425, 217, 638, 349, 431, 933, 626, 442, 756, 1672, 1670, 1663, 1657, 1681, 1588, 1586, 423, 1038,
                741, 138, 1377, 1395, 389, 1612, 1011, 1012, 331, 1043, 1042, 1034, 1031, 984, 1035, 1372, 1013, 983, 987, 807,
                124, 1033, 382, 934, 464, 1030, 560, 990, 930, 415, 121, 801, 631, 312, 1676, 920, 663, 1329, 1026, 925, 165, 412,
                777, 1322, 1679, 1662, 1660, 1397, 425, 776, 1571, 173, 505, 919, 661, 617, 779, 346, 595, 547, 21, 113, 931, 153,
                614, 637, 705, 376, 434, 132, 82, 393, 257, 491, 156, 680, 25, 662, 1021, 151, 681, 927, 258, 591, 642, 533, 319,
                715, 575, 59, 589, 1331, 315, 355, 461, 247, 23, 495, 463, 313, 921, 214, 384, 831, 278, 502, 743, 828, 1578,
                1332, 66, 810, 494, 31, 917, 601, 555, 929, 308, 410, 567, 1669, 1668, 1667, 1376, 664, 1039, 454, 850, 737, 288,
                455, 563, 481, 328, 406, 250, 1585, 669, 1562, 1365, 685, 769, 223, 757, 765, 1436, 1330, 1394, 521, 277, 325,
                365, 102, 409, 912, 613, 996, 35, 273, 1036, 928, 322, 367, 333, 774, 723, 648, 520, 794, 675, 55, 924, 1680,
                1620, 1674, 799, 1584, 834, 798, 608, 644, 12, 1570, 352, 516, 686, 659, 821, 518, 485, 53, 311, 309, 918, 1037,
                1371, 935, 615, 994, 401, 477, 125, 145, 566, 542, 22, 462, 123, 267, 127, 1046, 1335, 100, 323, 898, 1649, 1598,
                150, 897, 633, 726, 405, 1003, 279, 304, 79, 447, 689, 529, 1000, 740, 1683, 187, 427, 162, 1593, 597, 146, 1171)
        ...
        """
        params = {"userRegion": 193,
                  "resource": "schedule",
                  "ncrd": ncrd,
                  "params": json.dumps({"fields": "schedules,channel,title,id,events,channelId,start,finish,program,availableChannels,availableChannelsIds",
                                        "duration": 96400,
        ...
        with open(self.yatv_file_json, 'ab+') as fp:
            #             fp.write('[')
            #             m = params["params"]["channelProgramsLimit"] / params["params"]["channelLimit"]
            #             for n in range(0, m):
            #                 params["params"]["channelOffset"] = n * params["params"]["channelLimit"]
            ...
            try:
                r = defines.request(url, params=params, session=sess, headers={'Referer': 'https://tv.yandex.ru/'})
                fp.write(r.content)
#                 if n < m - 1:
#                     fp.write(',')
            except Exception as e:
